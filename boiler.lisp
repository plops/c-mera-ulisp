...
(%function _eval ((o form)
  ...
  (decl ((int TC 0))
	...
	(%push head gc-stack)  (comment "push head on gc-stack")
	(decl ((o tail head))
	  (set form (%cdr form))
	  (decl ((int nargs 0))
	    ...
	    (when (== *symbol* (cons-type function)) (comment "function of type symbol")
	      (decl ((uintgr name (cons-name function)))
		(if (<= (cl:length *builtin-declaration*) name) (comment "name is bultin")
		    (%err "not a function"))
