...
o gc_stack;
uintgr freespace;
cons_object workspace[128 * 1024 * 1024];
char return_flag = 0;
char buffer[7 + 1];
char last_char;
void *NULL = 0;
...
o sp_dolist(o args, o env)
{
	...
	o params = ((o)args)->car;
	o var = ((o)params)->car;
	o list = _eval(((o)((o)params)->cdr)->car, env);
	if (0 == ((2 != ((cons_symbol*)list)->type) && (1 != ((cons_symbol*)list)->type))) {
		//not listp
		_putsn("(arg is not a list)", 19);
		_putsn("EXIT\n", 6);
		exit(0);
	}
	//don't gc the list
	gc_stack = _cons(list, gc_stack);
	o pair = _cons(var, NULL);
	env = _cons(pair, env);
	o result = ((o)((o)((o)params)->cdr)->cdr)->car;
	o forms = ((o)args)->cdr;
	while (NULL != list) {
		o e = ((o)list)->car;
		((void)e);
		((o)pair)->cdr = e;
		_eval(tf_progn(forms, env), env);
		list = ((o)list)->cdr;
	}
	((o)pair)->cdr = NULL;
...
void sweep(void)
{
	freelist = 0;
	freespace = 0;
	for(int i = (128 * 1024 * 1024) - 1; 0 <= i; i = i - 1){
		o obj = workspace + i;
...
{
	freelist = 0;
	for(intgr i = (128 * 1024 * 1024) - 1; 0 <= i; i = i - 1){
		o obj = workspace + i;
		((o)obj)->car = 0;
		((o)obj)->cdr = freelist;
		freelist = obj;
