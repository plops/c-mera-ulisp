...
const char builtin_name[28][9] = { "symbols", "nil", "tee", "lambda", "let", "letstar", "closure", "specfrms", "quote", "defun", "defvar", "setq", "loop", "push", "pop", "incf", "decf", "progn", "return", "if", "cond", "and", "or", "functions", "not", "cons", "atom", "listp" };
